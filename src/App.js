...
const App = () => {
  ...
  useEffect(() => {
    ...
    const fetchNFTMetadata = async () => {
      ...
      console.log("CheckIfUserHasNFT",txn);
      if (txn[1]){
        console.log("CharacterNFT: ", txn[0]);
        setCharacterNFT(transformCharacterData(txn[0]));
      }else{
        console.log("CharacterNFT is not found");
  ...
  //<=ここにcurrentAccountを置くことで、更新時にこのuseEffectが発火するとのこと
